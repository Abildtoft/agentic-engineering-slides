...
<!--
KEY POINTS:
- Open on Naur: "a program is a theory that lives in the minds of the developers"
...
ADDITIONAL POINTS:
- Naur gets no slide of his own — he is the durable pre-AI anchor, and everything in this section is an implication of the idea: "A program is more than its source code. Rather a program is a theory that lives in the minds of the developers." Code artifacts are not the same thing as shared understanding
...
<!--
KEY POINTS:
- Lead-in diagnosis: "velocity without understanding is not sustainable"
- The trap is the frictionless path, not the tool itself
- CodeRabbit: 1.7x more bugs in AI-generated code, 1.4x more critical issues
- "Understanding" is the irreducibly human work that becomes judgment
...
- More evidence if the room wants it: Fastly found 30% of senior developers say auditing AI output offsets their time savings, and ~33% of seniors ship half their code as AI-generated versus only 13% of juniors (CodeRabbit's study is comparative, AI-generated vs human-written)
...
- "Understanding" is the integration your brain does that becomes judgment
...
- Cognitive debt weakens multiple layers at once
...
ADDITIONAL POINTS:
- Layers weaken because people stop understanding intent, assumptions, and failure modes
...
<!--
KEY POINTS:
- Wrong AI: 79.8% still followed — that's the problem. Correct AI: 92.7% — expected
- Accuracy: 45.8% without AI, 71.0% with correct AI, 31.5% with wrong AI — worse than none
- Confidence rose 11.7 points across the board, including on wrong answers
- Kahneman setup before the last click: System 1, System 2 — AI is System 3
- Surrender ≠ offloading: the brain recodes the AI's answer as YOUR judgment

BRIDGE: "And the dangerous part is how this shows up in everyday working habits."

ADDITIONAL POINTS:
- System 3 in full: an external cognitive system operating outside your brain
- Surrender vs offloading: with a calculator you know the tool did the work; with surrender you genuinely believe you reasoned it through. Not laziness — a cognitive architecture problem
...
- People didn't just follow bad advice, they became more sure of it
...
<!--
KEY POINTS:
- Mechanism, while the spiral is on screen: each prompt is a slot-machine pull
- "Epistemic rabbit holes": never quite enough to stop, always enough to continue
- Every step feels locally rational; dependency forms by accumulation
- thdxr: agents have "eroded our ability to delay gratification"
- No moralising — the mechanism is predictable, and predictable means manageable

BRIDGE: "Leave that spiral unchecked, and you stop outsourcing effort occasionally and start outsourcing it by default."

ADDITIONAL POINTS:
- Variable-ratio reinforcement, the same schedule that makes gambling compulsive — each response partially satisfies but opens a new question. "Epistemic rabbit holes" is the researchers' term
- The risk is gradual substitution of construction with passive review; not one dramatic event
...
- thdxr in full: "We went from barely using coding agents to using them for every minor change in the past 6 months and I think they've eroded our ability to delay gratification"
...
- Willison sharpens it: poor output is a harness failure, not a model limitation
- Stakes: comprehension failures become incidents, fines and trust damage
- Second click = governance posture: safeguards, accountability, continued deployment

ADDITIONAL POINTS:
- Agents CAN produce quality code if you invest in the system around them
- Raise the stakes before the release valve: cognitive debt can be catastrophic in security, privacy and compliance — not just inelegant code. Every technology wave creates new ways to harm people — databases, social media, AI all changed the harm surface area — but fear of possible harm cannot be the whole operating model
- The governance posture in full: risk awareness, safeguards, accountability, and continued deployment. Keep the tone sober rather than alarmed
...
- The reasoning log is the third check that didn't fit on screen: capture why this approach won, what was rejected, and what validated it
- The full-understanding line is the long form of the explainability gate, trimmed from the slide
