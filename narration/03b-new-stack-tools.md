<!-- 23. section — The New Stack: Tools -->
...
<!-- 24. two-cols-header — Markdown Is the Program Now — ~2 clicks -->
...
<!-- 25. default — Skills: Reusable Playbooks — ~2 clicks -->
...
<!-- 26. center — The Kitchen Analogy — ~3 clicks -->
...
<!-- 27. default — MCP Example: Figma ↔ Frontend — ~3 clicks -->
...
<!-- 28. default — Harness Engineering — ~2 clicks -->
...
<!-- 29. default — Guardrails — ~3 clicks -->
...
<!-- 30. default — Set the Constraints Around Your Agents — ~3 clicks -->
...
<!-- 31. default — From Issue to Pull Request: One Command — ~3 clicks -->
...
<!-- 32. center — Temperature Check — Demo, Questions, Break? -->
